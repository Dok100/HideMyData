...
- den verbleibenden Restkern von `PatternMatcher.swift` und `PIIDetector.swift` nach den neuen Support-Extraktionen erneut auf verbleibende Altanteile bewerten
